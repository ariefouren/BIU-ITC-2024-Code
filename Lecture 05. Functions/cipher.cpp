...
int main()
{
    int encryptionKey[KEY_LENGTH];
    int decryptionKey[KEY_LENGTH];

    char plainText[MAX_TEXT_LEN];
    char encryptedText[MAX_TEXT_LEN];
    char decryptedText[MAX_TEXT_LEN];
    ...
    // note that the decryption is an encryption of the ciphertext 
